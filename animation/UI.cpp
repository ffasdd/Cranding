...
HRESULT UILayer::Initialize(UINT nFrames, UINT nTextBlocks, ID3D12Device* pd3dDevice, ID3D12CommandQueue* pd3dCommandQueue, ID3D12Resource** ppd3dRenderTargets, UINT nWidth, UINT nHeight)
{
    ...
    // text format
    m_textFormats[TEXT_SIZE::SIZE_15] = CreateTextFormat(L"∏º¿∫ ∞ÌµÒ", 15.0f * 3.35f);
    m_textFormats[TEXT_SIZE::SIZE_18] = CreateTextFormat(L"∏º¿∫ ∞ÌµÒ", 18.0f * 3.35f);
    m_textFormats[TEXT_SIZE::SIZE_25] = CreateTextFormat(L"∏º¿∫ ∞ÌµÒ", 25.0f * 3.35f);
    m_textFormats[TEXT_SIZE::SIZE_30] = CreateTextFormat(L"∏º¿∫ ∞ÌµÒ", 30.0f * 3.35f);
    m_textFormats[TEXT_SIZE::SIZE_50] = CreateTextFormat(L"∏º¿∫ ∞ÌµÒ", 50.0f * 3.35f);
    m_textFormats[TEXT_SIZE::SIZE_60] = CreateTextFormat(L"∏º¿∫ ∞ÌµÒ", 80.0f * 3.35f);
