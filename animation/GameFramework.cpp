...
{
	m_pScene->m_ppHierarchicalGameObjects[23]->isdraw = true;
	m_pScene->m_ppHierarchicalGameObjects[23]->SetPosition(position);
	m_pScene->m_ppHierarchicalGameObjects[23]->m_pChild->m_pChild->m_pSibling->m_pSibling->m_pSibling->m_xmBoundingBox.Center = position;
	//m_pScene->m_ppHierarchicalGameObjects[n + 3]->SetScale(20, 20, 20);
}
...
{
	m_pScene->m_ppHierarchicalGameObjects[23]->SetLook(Look.x, Look.y, Look.z);
	m_pScene->m_ppHierarchicalGameObjects[23]->SetUp(0, 1, 0);
	m_pScene->m_ppHierarchicalGameObjects[23]->SetRight(Right.x, Right.y, Right.z);
	m_pScene->m_ppHierarchicalGameObjects[23]->SetScale(20, 20, 20);
