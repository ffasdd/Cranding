...
void CPlayer::Move(DWORD dwDirection, float fDistance, bool bUpdateVelocity)
{
	if (dwDirection)
	{
		...
		Move(0, xmf3Shift, bUpdateVelocity);
	}
}
...
CTerrainPlayer::CTerrainPlayer(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, void* pContext, int sNum)
{
	...
	m_pSkinnedAnimationController->SetCallbackKeys(7, 1);
	...
	//m_pSkinnedAnimationController->SetCallbackKey(0, 0, 0.0f, _T("Sound/Attack2.wav"));
	//m_pSkinnedAnimationController->SetCallbackKey(1, 0, 0.0f, _T("Sound/Attack2.wav"));
	...
	//CAnimationCallbackHandler* pAnimationCallbackHandler2 = new CSoundCallbackHandler();
	//CAnimationCallbackHandler* pAnimationCallbackHandler3 = new CSoundCallbackHandler();

	m_pSkinnedAnimationController->SetAnimationCallbackHandler(1, pAnimationCallbackHandler1);
	//m_pSkinnedAnimationController->SetAnimationCallbackHandler(6, pAnimationCallbackHandler2);
	//m_pSkinnedAnimationController->SetAnimationCallbackHandler(7, pAnimationCallbackHandler3);
