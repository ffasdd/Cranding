...
enum class SENDTYPE : INT { MOVE, ROTATE, ATTACK,CHANGE_ANIMATION,CHANGE_SCENE_LOBBY, CHANGE_SCENE_INGAME_READY,CHANGE_SCENE_INGAME_START,TIME_CHECK,
	ATTACK_COLLISION, CHANGE_STAGE , NPC_DIE, NPC_ATTACK_TO_SPACESHIP, PLAYER_HIT};
...
enum TEXT_SIZE { SIZE_8 , SIZE_15, SIZE_18, SIZE_25, SIZE_35, SIZE_40, SIZE_50, SIZE_60, TEXT_COUNT };
