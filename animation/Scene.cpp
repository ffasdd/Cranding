...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	CreateCbvSrvDescriptorHeaps(pd3dDevice, 0, 50); //SuperCobra(17), Gunship(2), Player:Mi24(1), Angrybot()
...
void CLoginScene::BuildObjects(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList)
{
	...
	m_ppHierarchicalGameObjects[2]->SetPosition(45.0f, 0.0f, -85.0f);
	...
	m_ppHierarchicalGameObjects[3]->SetPosition(15.0f, 0.0f, -85.0f);
