...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	CLoadedModelInfo *pAngrybotModel = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/SK_Mesh_Astronaut.bin", NULL);
	...
	CLoadedModelInfo *pHumanoidModel = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/Shade.bin", NULL);
	...
	m_ppHierarchicalGameObjects[4]->SetScale(15.0f,15.0f, 15.0f);
	...
	m_ppHierarchicalGameObjects[5]->SetScale(15.0f,15.0f, 15.0f);
...
//*/
	...
	CLoadedModelInfo *pZebraModel = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/Slime_Cube.bin", NULL);
	...
	CLoadedModelInfo *pLionModel = CGameObject::LoadGeometryAndAnimationFromFile(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, "Model/Ice_Mage@Icicle_Attack.bin", NULL);
	...
	m_ppHierarchicalGameObjects[10]->SetScale(10.0f, 10.0f, 10.0f);
	...
	m_ppHierarchicalGameObjects[11]->SetScale(10.0f, 10.0f, 10.0f);
