...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	m_ppHierarchicalGameObjects[1] = new CMapObject(pd3dDevice, pd3dCommandList, m_pd3dGraphicsRootSignature, map, 0);
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice)
{
	...
	pd3dDescriptorRanges[5].BaseShaderRegister = 11; //t11: gtxtSkyBoxTexture
	...
	pd3dDescriptorRanges[8].BaseShaderRegister = 12; //t12: Texture2D<float4>
	...
	pd3dRootParameters[13].Descriptor.ShaderRegister = 9; //DrawOptions
	...
	pd3dRootParameters[14].DescriptorTable.pDescriptorRanges = &pd3dDescriptorRanges[8]; //Texture2D
