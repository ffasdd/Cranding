...
#define INGAME_SCENE_CAMERA			0x04
#define LOGIN_SCENE_CAMERA			0x05
...
class CLoginSceneCamera : public CCamera
{
public:
	CLoginSceneCamera(CCamera* pCamera);
	virtual ~CLoginSceneCamera() { }
