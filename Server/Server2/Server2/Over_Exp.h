...
enum class COMP_TYPE : int { Accept , Recv , Send,
	...
	ICE_BOSS_MOVE,FIRE_BOSS_MOVE,NATURE_BOSS_MOVE,PLAYER_ATTACKED_NPC,ICE_BOSS_SKILL,ICE_BOSS_CANCLE_SKILL,
	FIRE_BOSS_SKILL,FIRE_BOSS_CANCLE_SKILL,NATURE_BOSS_SKILL,NATURE_BOSS_SKILL_CANCLE
};
class Over_Exp
{
public:
